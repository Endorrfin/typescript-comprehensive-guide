...
const SIM_CANARIES: Record<string, string[]> = { ConditionalTypeSim: ["extends"] };
...
async function main(): Promise<void> {
  ...
  for (const hash of ["", "#/map", "#/m/m5-generics-conditional-types", "#/mental-models", "#/glossary", "#/does-not-exist"]) {
