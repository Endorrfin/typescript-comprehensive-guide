...
| # | id | Module | Level | Topics | Signature sim |
|---|---|---|---|---|---|
| 4 | `m4-generics` | Generic Functions & Classes | senior | parametric polymorphism · constraints · defaults · inference sites | — |
...
| 6 | `m6-mapped-template-literals` | Mapped & Template‑Literal Types | senior | `[K in keyof T]` · modifiers · key remapping (`as`) · template literal types | — |
